...
DEFAULT_COMPETITORS = [
    {
        "id": 1,
        "name": "Anand Hospital Cardiology",
        "location": "Meerut",
        "specialty": "Multi-Specialty Cardiac Care",
        "estimated_reviews": 156,
        "estimated_rating": 4.4,
        "strengths": ["Brand recognition", "Google Ads", "Multi-specialty"],
        "website": "",
    },
    {
        "id": 2,
        "name": "Lokpriya Hospital Heart Centre",
        "location": "Meerut",
        "specialty": "General Cardiology",
        "estimated_reviews": 98,
        "estimated_rating": 4.2,
        "strengths": ["Maps ranking", "Local citations", "Affordable pricing"],
        "website": "",
    },
    {
        "id": 3,
        "name": "Max Hospital Cardiac Care",
        "location": "Delhi NCR (Vaishali)",
        "specialty": "Interventional Cardiology",
        "estimated_reviews": 340,
        "estimated_rating": 4.6,
        "strengths": ["Brand authority", "Blog content", "Video content", "SEO budget"],
        "website": "",
    },
    {
        "id": 4,
        ...
        "location": "Delhi NCR",
        "specialty": "Cardiac Surgery & Intervention",
        "estimated_reviews": 510,
        "estimated_rating": 4.7,
        "strengths": ["Domain authority", "Patient reviews", "Content depth", "Backlinks"],
        "website": "",
    },
]
